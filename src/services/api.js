...
export const createDriverWalletPaymentOrder = (amount) => fetchJson("/drivers/wallet/addMoney", { method: "POST", body: JSON.stringify({ amount }) });
export const verifyDriverWalletPayment = (data) => fetchJson("/drivers/wallet/verify-payment", { method: "POST", body: JSON.stringify(data) });
export const addMoneyToDriverWallet = (amount) => createDriverWalletPaymentOrder(amount);
